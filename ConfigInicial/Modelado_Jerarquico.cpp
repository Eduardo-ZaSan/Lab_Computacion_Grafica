...
//For model
float	hombro = 0.0f, //Servira para las articulaciones
codo = 0.0f,
muneca = 0.0f,
dedo1 = 0.0f,
dedo2 = 0.0f,
...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Modelado jerarquico Eduardo Zavala Sanchez", nullptr, nullptr);
	...
	//El color ahora va a ir en otro lado a comparacion con los codigos anteriores
	float vertices[] = {
		-0.5f, -0.5f, 0.5f, 
		0.5f, -0.5f, 0.5f,  
		0.5f,  0.5f, 0.5f,  
